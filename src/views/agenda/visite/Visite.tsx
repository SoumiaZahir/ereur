    ...
    <>
      <Card sx={{ backgroundColor: visiteBgColor, alignItems: 'center', position: 'relative' }}>
        ...
        <Grid container sx={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
          ...
          <CustomIconButton>
            <dfn title='Detail Produit'>
              <Icon
                icon='tabler:info-square'
                fontSize='1.625rem'
                className='tabler-icon-filled'
                color={visite.statut === 'absent' ? 'white' : '#860C90'}
        ...
        <CardHeader
          title={
            <Typography
              style={{
                color: visite.statut === 'absent' ? 'white' : undefined,
                display: 'flex',
        ...
        <CardContent>
          ...
          <Typography variant='body2' sx={{ display: 'flex', gap: '10px' }}>
            <Icon icon='tabler:clock-cancel' style={{ color: 'red', fontSize: '25px' }} />
            <Icon icon='tabler:alarm-snooze' style={{ color: 'red', fontSize: '25px' }} />
            <Icon icon='tabler:arrows-sort' style={{ color: 'red', fontSize: '25px' }} />
            <Icon icon='tabler:shopping-cart-off' style={{ color: 'red', fontSize: '25px' }} />
            <Icon icon='tabler:shopping-cart-exclamation' style={{ color: 'red', fontSize: '25px' }} />
            <Icon icon='tabler:camera-exclamation' style={{ color: 'red', fontSize: '25px' }} />
          </Typography>
        </CardContent>
